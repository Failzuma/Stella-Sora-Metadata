...
constexpr unsigned char __ROR1__(unsigned char value, unsigned int shift) noexcept {
    return std::rotr(value, shift);
}

void __fastcall DecryptionChunk(__int64 a1, unsigned __int64 a2, _BYTE* a3, __int64 a4, unsigned int a5)
{
    __int64 v8; // rsi
    __int64 v9; // rdx
    char v10; // al
